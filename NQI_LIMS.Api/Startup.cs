...
using NQI_LIMS.Extensions;
using NQI_LIMS.Filter;
using NQI_LIMS.Hubs;
using NQI_LIMS.IServices;
using NQI_LIMS.Middlewares;
...
namespace NQI_LIMS
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, MyContext myContext, ITasksQzServices tasksQzServices, ISchedulerCenter schedulerCenter, IHostApplicationLifetime lifetime)
        {
            ...
            // 封装Swagger展示
            app.UseSwaggerMildd(() => GetType().GetTypeInfo().Assembly.GetManifestResourceStream("NQI_LIMS.Api.index.html"));
